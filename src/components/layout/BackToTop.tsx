    ...
    <AnimatePresence>
      {visible && (
        <motion.button
          ...
          className="fixed bottom-6 right-6 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-yellow text-navy shadow-lg ring-1 ring-navy/10 backdrop-blur transition-colors duration-200 hover:bg-yellow-600 hover:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-yellow focus-visible:ring-offset-2 focus-visible:ring-offset-navy md:bottom-8 md:right-8 md:h-14 md:w-14"
        >
          <ArrowUp
